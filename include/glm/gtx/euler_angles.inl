...
template<typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleZX( T const& angleZ, T const& angleX )
{
...
orientate3( vec<3, T, Q> const& angles )
{
...
orientate4( vec<3, T, Q> const& angles )
{
...
template<typename T>
GLM_FUNC_DECL void
extractEulerAngleXYZ( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
...
extractEulerAngleYXZ( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleXZX( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleXYX( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
  ...
  T C1 = glm::cos( T1 );
  T T3 =
    glm::atan2( -C1 * M[2][1] - S1 * M[2][2], C1 * M[1][1] + S1 * M[1][2] );
  t1 = T1;
  t2 = T2;
  t3 = T3;
}
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleYXY( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleYZY( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
  ...
  T C1 = glm::cos( T1 );
  T T3 =
    glm::atan2( -S1 * M[0][0] - C1 * M[0][2], S1 * M[2][0] + C1 * M[2][2] );
  t1 = T1;
  t2 = T2;
  t3 = T3;
}
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleZYZ( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleZXZ( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
  ...
  T C1 = glm::cos( T1 );
  T T3 =
    glm::atan2( -C1 * M[1][0] - S1 * M[1][1], C1 * M[0][0] + S1 * M[0][1] );
  t1 = T1;
  t2 = T2;
  t3 = T3;
}
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleXZY( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleYZX( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleZYX( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
...
template<typename T>
GLM_FUNC_QUALIFIER void
extractEulerAngleZXY( mat<4, 4, T, defaultp> const& M, T& t1, T& t2, T& t3 )
{
