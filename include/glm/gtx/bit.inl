...
highestBitValue( genIUType Value )
{
  genIUType tmp = Value;
...
highestBitValue( vec<L, T, Q> const& v )
{
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<L, T, Q>
lowestBitValue( vec<L, T, Q> const& v )
{
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<L, T, Q>
powerOfTwoAbove( vec<L, T, Q> const& v )
{
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<L, T, Q>
powerOfTwoBelow( vec<L, T, Q> const& v )
{
...
template<typename genType>
GLM_FUNC_QUALIFIER genType
powerOfTwoNearest( genType value )
{
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<L, T, Q>
powerOfTwoNearest( vec<L, T, Q> const& v )
{
