...
intersectRayPlane( genType const& orig,
                   genType const& dir,
...
GLM_FUNC_QUALIFIER bool
intersectRayTriangle( vec<3, T, Q> const& orig,
                      vec<3, T, Q> const& dir,
...
template<typename genType>
GLM_FUNC_QUALIFIER bool
intersectLineTriangle( genType const& orig,
                       genType const& dir,
                       genType const& vert0,
                       genType const& vert1,
                       genType const& vert2,
                       genType& position )
{
  ...
  if ( det > -Epsilon && det < Epsilon )
    return false;
  typename genType::value_type inv_det =
...
template<typename genType>
GLM_FUNC_QUALIFIER bool
intersectLineSphere( genType const& point0,
