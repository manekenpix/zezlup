...
template<length_t D, typename T, qualifier Q>
GLM_INLINE mat<D, D, T, Q>
computeCovarianceMatrix( vec<D, T, Q> const* v,
                         size_t n,
                         vec<D, T, Q> const& c )
{
...
GLM_FUNC_DECL mat<D, D, T, Q>
computeCovarianceMatrix( I const& b, I const& e )
{
  glm::mat<D, D, T, Q> m( 0 );
...
template<typename T>
GLM_INLINE T
transferSign( T const& v, T const& s )
{
...
GLM_INLINE void
sortEigenvalues( vec<2, T, Q>& eigenvalues, mat<2, 2, T, Q>& eigenvectors )
{
...
template<typename T, qualifier Q>
GLM_INLINE void
sortEigenvalues( vec<3, T, Q>& eigenvalues, mat<3, 3, T, Q>& eigenvectors )
{
  if ( eigenvalues[0] < eigenvalues[1] ) {
    std::swap( eigenvalues[0], eigenvalues[1] );
    std::swap( eigenvectors[0], eigenvectors[1] );
...
template<typename T, qualifier Q>
GLM_INLINE void
sortEigenvalues( vec<4, T, Q>& eigenvalues, mat<4, 4, T, Q>& eigenvectors )
{
  if ( eigenvalues[0] < eigenvalues[2] ) {
    std::swap( eigenvalues[0], eigenvalues[2] );
    std::swap( eigenvectors[0], eigenvectors[2] );
