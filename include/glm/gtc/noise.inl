...
grad4( T const& j, vec<4, T, Q> const& ip )
{
  vec<3, T, Q> pXYZ =
    floor( fract( vec<3, T, Q>( j ) * vec<3, T, Q>( ip ) ) * T( 7 ) ) * ip[2] -
    T( 1 );
...
perlin( vec<2, T, Q> const& Position )
{
  vec<4, T, Q> Pi = glm::floor( vec<4, T, Q>(
                      Position.x, Position.y, Position.x, Position.y ) ) +
                    vec<4, T, Q>( 0.0, 0.0, 1.0, 1.0 );
  vec<4, T, Q> Pf = glm::fract( vec<4, T, Q>(
                      Position.x, Position.y, Position.x, Position.y ) ) -
                    vec<4, T, Q>( 0.0, 0.0, 1.0, 1.0 );
  Pi = mod( Pi,
            vec<4, T, Q>( 289 ) ); // To avoid truncation effects in permutation
  ...
  vec<4, T, Q> norm = detail::taylorInvSqrt( vec<4, T, Q>(
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER T
perlin( vec<3, T, Q> const& Position )
{
  ...
  vec<4, T, Q> iy =
    vec<4, T, Q>( vec<2, T, Q>( Pi0.y ), vec<2, T, Q>( Pi1.y ) );
  vec<4, T, Q> iz0( Pi0.z );
  vec<4, T, Q> iz1( Pi1.z );
  ...
  vec<4, T, Q> norm0 =
    detail::taylorInvSqrt( vec<4, T, Q>( dot( g000, g000 ),
                                         dot( g010, g010 ),
                                         dot( g100, g100 ),
                                         dot( g110, g110 ) ) );
  g000 *= norm0.x;
  ...
  g110 *= norm0.w;
  vec<4, T, Q> norm1 =
    detail::taylorInvSqrt( vec<4, T, Q>( dot( g001, g001 ),
                                         dot( g011, g011 ),
                                         dot( g101, g101 ),
                                         dot( g111, g111 ) ) );
  g001 *= norm1.x;
  ...
  vec<4, T, Q> n_z = mix( vec<4, T, Q>( n000, n100, n010, n110 ),
                          vec<4, T, Q>( n001, n101, n011, n111 ),
                          fade_xyz.z );
  vec<2, T, Q> n_yz = mix(
    vec<2, T, Q>( n_z.x, n_z.y ), vec<2, T, Q>( n_z.z, n_z.w ), fade_xyz.y );
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER T
perlin( vec<4, T, Q> const& Position )
{
  ...
  vec<4, T, Q> gw00 =
    vec<4, T, Q>( 0.75 ) - abs( gx00 ) - abs( gy00 ) - abs( gz00 );
  ...
  vec<4, T, Q> gw01 =
    vec<4, T, Q>( 0.75 ) - abs( gx01 ) - abs( gy01 ) - abs( gz01 );
  ...
  vec<4, T, Q> gw10 =
    vec<4, T, Q>( 0.75 ) - abs( gx10 ) - abs( gy10 ) - abs( gz10 );
  ...
  vec<4, T, Q> gw11 =
    vec<4, T, Q>( 0.75 ) - abs( gx11 ) - abs( gy11 ) - abs( gz11 );
  ...
  vec<4, T, Q> norm00 =
    detail::taylorInvSqrt( vec<4, T, Q>( dot( g0000, g0000 ),
                                         dot( g0100, g0100 ),
                                         dot( g1000, g1000 ),
                                         dot( g1100, g1100 ) ) );
  g0000 *= norm00.x;
  ...
  vec<4, T, Q> norm01 =
    detail::taylorInvSqrt( vec<4, T, Q>( dot( g0001, g0001 ),
                                         dot( g0101, g0101 ),
                                         dot( g1001, g1001 ),
                                         dot( g1101, g1101 ) ) );
  g0001 *= norm01.x;
  ...
  vec<4, T, Q> norm10 =
    detail::taylorInvSqrt( vec<4, T, Q>( dot( g0010, g0010 ),
                                         dot( g0110, g0110 ),
                                         dot( g1010, g1010 ),
                                         dot( g1110, g1110 ) ) );
  g0010 *= norm10.x;
  ...
  vec<4, T, Q> norm11 =
    detail::taylorInvSqrt( vec<4, T, Q>( dot( g0011, g0011 ),
                                         dot( g0111, g0111 ),
                                         dot( g1011, g1011 ),
                                         dot( g1111, g1111 ) ) );
  g0011 *= norm11.x;
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER T
perlin( vec<2, T, Q> const& Position, vec<2, T, Q> const& rep )
{
  vec<4, T, Q> Pi =
  ...
  Pi = mod(
    Pi,
    vec<4, T, Q>(
      rep.x, rep.y, rep.x, rep.y ) ); // To create noise with explicit period
  Pi = mod( Pi,
            vec<4, T, Q>( 289 ) ); // To avoid truncation effects in permutation
  vec<4, T, Q> ix( Pi.x, Pi.z, Pi.x, Pi.z );
  vec<4, T, Q> iy( Pi.y, Pi.y, Pi.w, Pi.w );
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER T
perlin( vec<3, T, Q> const& Position, vec<3, T, Q> const& rep )
{
  vec<3, T, Q> Pi0 =
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER T
perlin( vec<4, T, Q> const& Position, vec<4, T, Q> const& rep )
{
...
simplex( glm::vec<2, T, Q> const& v )
{
  ...
  // i1.y = 1.0 - i1.x;
  vec<2, T, Q> i1 =
    ( x0.x > x0.y ) ? vec<2, T, Q>( 1, 0 ) : vec<2, T, Q>( 0, 1 );
  // x0 = x0 - 0.0 + 0.0 * C.xx ;
  // x1 = x0 - i1 + 1.0 * C.xx ;
  // x2 = x0 - 1.0 + 2.0 * C.xx ;
  vec<4, T, Q> x12 =
  ...
  vec<3, T, Q> p = detail::permute(
    detail::permute( i.y + vec<3, T, Q>( T( 0 ), i1.y, T( 1 ) ) ) + i.x +
...
simplex( vec<3, T, Q> const& v )
{
  ...
  vec<4, T, Q> p( detail::permute(
    detail::permute(
      detail::permute( i.z + vec<4, T, Q>( T( 0 ), i1.z, i2.z, T( 1 ) ) ) +
...
simplex( vec<4, T, Q> const& v )
{
  ...
  vec<4, T, Q> i0;
  vec<3, T, Q> isX =
    step( vec<3, T, Q>( x0.y, x0.z, x0.w ), vec<3, T, Q>( x0.x ) );
  vec<3, T, Q> isYZ =
  ...
  T j0 = detail::permute(
    detail::permute( detail::permute( detail::permute( i.w ) + i.z ) + i.y ) +
    i.x );
  ...
  vec<3, T, Q> m0 =
    max( T( 0.6 ) - vec<3, T, Q>( dot( x0, x0 ), dot( x1, x1 ), dot( x2, x2 ) ),
         vec<3, T, Q>( 0 ) );
  vec<2, T, Q> m1 =
    max( T( 0.6 ) - vec<2, T, Q>( dot( x3, x3 ), dot( x4, x4 ) ),
         vec<2, T, Q>( 0 ) );
  m0 = m0 * m0;
  m1 = m1 * m1;
  return T( 49 ) *
