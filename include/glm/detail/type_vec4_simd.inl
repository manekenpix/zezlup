...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, int, aligned_lowp>::vec( int _s )
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, int, aligned_mediump>::vec( int _s )
  : data( _mm_set1_epi32( _s ) )
{
}
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, int, aligned_highp>::vec( int _s )
  : data( _mm_set1_epi32( _s ) )
{
}
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, int, aligned_lowp>::vec( int _x, int _y, int _z, int _w )
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, int, aligned_highp>::vec( int _x, int _y, int _z, int _w )
  : data( _mm_set_epi32( _w, _z, _y, _x ) )
{
}
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, uint, aligned_lowp>::vec( uint _s )
  : data( vdupq_n_u32( _s ) )
{
}
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, uint, aligned_mediump>::vec( uint _s )
  : data( vdupq_n_u32( _s ) )
{
}
...
template<>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, uint, aligned_highp>::vec( uint _s )
  : data( vdupq_n_u32( _s ) )
{
}
...
vec<4, float, aligned_mediump>::vec( uint _x, uint _y, uint _z, uint _w )
  : data(
      vcvtq_f32_u32( vec<4, uint, aligned_mediump>( _x, _y, _z, _w ).data ) )
{
}
