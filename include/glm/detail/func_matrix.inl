...
struct compute_matrixCompMult_type
{
                                                  ...
                                                  mat<C, R, T, Q> const& y )
  {
    ...
    return detail::
      compute_matrixCompMult<C, R, T, Q, detail::is_aligned<Q>::value>::call(
        x, y );
  }
};
...
struct compute_transpose_type
{
  GLM_FUNC_QUALIFIER static mat<R, C, T, Q> call( mat<C, R, T, Q> const& m )
  {
    GLM_STATIC_ASSERT(
      ...
      "<glm/ext/matrix_integer.hpp> to discard this restriction." );
    return detail::compute_transpose<C, R, T, Q, detail::is_aligned<Q>::value>::
      call( m );
  }
};
...
struct compute_determinant_type
{
  ...
  GLM_FUNC_QUALIFIER static T call( mat<C, R, T, Q> const& m )
  {
    GLM_STATIC_ASSERT(
      ...
      "<glm/ext/matrix_integer.hpp> to discard this restriction." );
    return detail::
      compute_determinant<C, R, T, Q, detail::is_aligned<Q>::value>::call( m );
  }
};
...
{
  return detail::
    compute_outerProduct_type<DA, DB, T, Q, std::numeric_limits<T>::is_iec559>::
      call( c, r );
}
...
{
  return detail::compute_transpose_type<
    C,
    R,
    T,
    Q,
...
inverse( mat<C, R, T, Q> const& m )
{
  ...
  return detail::compute_inverse<C, R, T, Q, detail::is_aligned<Q>::value>::
    call( m );
}
} // namespace glm
