...
#define FT_MEM_REALLOC( ptr, cursz, newsz )                                    \
  FT_ASSIGNP_INNER(                                                            \
    ptr,                                                                       \
    ft_mem_realloc(                                                            \
      memory, 1, (FT_Long)( cursz ), (FT_Long)( newsz ), ( ptr ), &error ) )
...
#define FT_MEM_ALLOC_MULT( ptr, count, item_size )                             \
  FT_ASSIGNP_INNER(                                                            \
    ptr,                                                                       \
    ft_mem_realloc(                                                            \
      memory, (FT_Long)( item_size ), 0, (FT_Long)( count ), NULL, &error ) )

#define FT_MEM_REALLOC_MULT( ptr, oldcnt, newcnt, itmsz )                      \
  FT_ASSIGNP_INNER( ptr,                                                       \
                    ft_mem_realloc( memory,                                    \
                                    (FT_Long)( itmsz ),                        \
                                    (FT_Long)( oldcnt ),                       \
                                    (FT_Long)( newcnt ),                       \
                                    ( ptr ),                                   \
...
#define FT_MEM_NEW_ARRAY( ptr, count )                                         \
  FT_ASSIGNP_INNER(                                                            \
    ptr,                                                                       \
    ft_mem_realloc(                                                            \
      memory, sizeof( *( ptr ) ), 0, (FT_Long)( count ), NULL, &error ) )
