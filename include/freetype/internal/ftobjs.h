...
#define FT_DEFINE_OUTLINE_FUNCS(                                               \
  class_, move_to_, line_to_, conic_to_, cubic_to_, shift_, delta_ )           \
...
#define FT_DEFINE_GLYPH(                                                       \
  class_, size_, format_, init_, done_, copy_, transform_, bbox_, prepare_ )   \
  FT_CALLBACK_TABLE_DEF                                                        \
...
#define FT_DEFINE_RENDERER( class_,                                            \
                            ...
                            raster_class_ )                                    \
  FT_CALLBACK_TABLE_DEF                                                        \
  const FT_Renderer_Class class_ = { FT_DEFINE_ROOT_MODULE( flags_,            \
                                                            size_,             \
                                                            name_,             \
                                                            version_,          \
                                                            requires_,         \
