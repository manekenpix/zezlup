...
#define FT_READ_SHORT( var )                                                   \
  FT_READ_MACRO( FT_Stream_ReadUShort, FT_Short, var )
#define FT_READ_USHORT( var )                                                  \
  FT_READ_MACRO( FT_Stream_ReadUShort, FT_UShort, var )
#define FT_READ_UOFF3( var )                                                   \
  FT_READ_MACRO( FT_Stream_ReadUOffset, FT_ULong, var )
...
#define FT_READ_LONG_LE( var )                                                 \
  FT_READ_MACRO( FT_Stream_ReadULongLE, FT_Long, var )
